    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('adminStaffAcc.store' )}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="phoneNumber" class="col-md-4 col-form-label text-md-right">{{ __('Contact number') }}</label>
...
<script>
    $("#department").change(function(){
        $.ajax({
            url: "{{ route('adminStaffAcc.sp') }}?department=" + $(this).val(),
            method: 'GET',
            success: function(result) {                
                $('#specialty').html(result.sp);
            }
        });
    });
    ...
    $("#role").change(function(){
        $.ajax({
            url: "{{ route('adminStaffAcc.department') }}?role=" + $(this).val(),
            method: 'GET',
            success: function(result) {                
                $('#department').html(result.dp);
            }
        });
    });
</script>
