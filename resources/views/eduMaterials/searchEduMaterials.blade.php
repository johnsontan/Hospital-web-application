...
<div class="container pt-5">
    <div class="row justify-content-center">
        <h1 class="text-center">Search for Educational Materials</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 align-items-sm-center h-100">
        ...
        <table class="table table-striped table-sm mb-3 mt-3">
            ...
            <tbody>
                ...
                @foreach($eduMaterials as $eduMaterial) 
                    <tr class="h-100">
                    <th scope="row" class="align-middle h-100">{{$eduMaterial->id}}</th>
                    <td class="align-middle h-100">{{$eduMaterial->title}}</td>
                    <td class="align-middle h-100">{{$eduMaterial->created_at->toDateString()}}</td>  
                      <!-- Display of tags -->
                    ...
                    <td class="align-middle">
                        <a href="/viewEduMaterials/{{ $eduMaterial->id }}" class="btn btn-outline-primary btn-sm align-end" type="button">See More</a>
                    </td>
                    </tr>
                @endforeach
                ...
                <!-- Displayed searched results -->
                    ...
                    <td class="align-middle h-100">{{$searchResult->created_at->toDateString()}}</td>   
                      <!-- Display of tags -->
                      <td class= "align-middle h-100" >
                    ...
                    <td class="align-middle">
                        <a href="/viewEduMaterials/{{ $searchResult->id }}" class="btn btn-outline-primary btn-sm align-end" type="button">See More</a>
                    </td>
                    </tr>
                    @endforeach
