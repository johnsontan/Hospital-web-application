...
@section('content')
    ...
    <div class="container">
        <h1 class="text-center mb-3">VIEW ALL HEALTH RECORDS<h1> 
    </div>
    ...
    <div class="container my-4">
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th class="col-sm-4">Appointment ID</th>
                    <th class="col-sm-4">Health Record ID</th>
            ...
            <tbody>                   
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="/viewMoreMedicalRecords/{{ $record->id }}" class="btn btn-outline-primary btn-sm align-end" type="button">See More</a></td>    
                </tr>
                @endforeach
                @else
