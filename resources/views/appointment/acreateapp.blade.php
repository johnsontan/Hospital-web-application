...
@section('content')
    ...
    <h1 class="text-center mx-5">Book an appointment</h1>
    <div class="container justify-content-center align-items-center d-flex mt-5">
    
        <form action="{{ route('abookApp.store') }}" method="post" class="col-8 p-2">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 justify-content-center align-items-center d-flex">
                    <label for="specialisation" class="fw-bold mt-3 mb-2">Consulation</label>                
                </div>
            </div>
