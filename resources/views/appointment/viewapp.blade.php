                        ...
                        @if($upcomingApp->isNotEmpty())
                            @foreach ($upcomingApp as $app)
                                <tr>
                                    ...
                                    <td>{{ $app->treatment->specialisation->specialisation }}</td>
                                    <td class="d-flex">
                                        <a href="{{ route('bookApp.edit', ['appointment' => $app->id]) }}" class="btn btn-secondary mr-2">Edit</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($app->feedback()->get()->isEmpty())
                                            <a href="{{route('feedback.create', ['app' => $app])}}" class="btn btn-primary">Feedback</a>
                                        @else
                                            Feedback posted
                                        @endif
                                    </td>
                            ...
                            <tbody>
                                    @foreach ($lapseApp as $app)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                    <a href="{{ route('bookApp.edit', ['appointment' => $app->id]) }}" class="btn btn-secondary mr-2">Reschedule</a>
                                                    <form action="{{ route('bookApp.destory', ["appointment" => $app->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this appointment?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn btn-danger" type="submit">Delete</button>
