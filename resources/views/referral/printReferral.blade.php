...
@if (isset($referrals) && isset($patient) && isset($ms))
    <div class="container border border-primary mt-5 mb-5">
        ...
        <div class="row">
                ...
                <p>
                    Hospital: {{ $referrals->hospitalName}}
                    </br>
                    Address: {{ $referrals->address}}, {{ $referrals->city }} {{ $referrals->postalCode}}
                    </br>
                    Date: {{ $referrals->referralDate}}
                    </br>
                    Time: {{ $referrals->referralTime}}
                    </br>
                    Reason(s) for referral: {{ $referrals->memo }}
                    </br>
                </p>
                </br> 
                ...
                <p>
                    ...
                    Contact Number: {{ $patient->phoneNumber }}
                    </br>
                </p>
        </div>
        </br></br>
        ...
        <div class="row">
            ...
            <thead>
                <tr>
                <th scope="col" class="col-1 align-middle">Medication Name</th>
                <th scope="col" class="col-2 align-middle">Quantity</th>
                </tr>
            </thead>
            <tbody>
            ...
            @if(!empty($prescriptions))
                ...
                <tr>
                    <th scope="row" class="align-middle">{{$p->medicationName}}</th>
                    <td class="align-middle">{{$p->quantity}}</td>
                </tr>
                @endforeach
            @else
                <tr>
                    <th scope="row" class="align-middle">NIL</th>
        ...
        <div class="row">
            ...
            @foreach($testResults as $t)
                <tr>
                    <th scope="row" class="align-middle">{{$t->content}}</th>
                </tr>
                @endforeach
            @else
                <tr>
        ...
        <div class="row">
            <p>
                Signed Digitally by Dr {{ $ms->name }}
                </br>
                {{ $ms->specialisation }}
            </p>
            <p>
